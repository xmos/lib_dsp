 ...
 */
void lib_dsp_dct_forward32(int32_t output[32], int32_t input[32]);
 ...
 *  \param  output          DCT values.
 */
void lib_dsp_dct_forward24(int32_t output[24], int32_t input[24]);
 ...
 *  \param  output          DCT values.
 */
void lib_dsp_dct_forward16(int32_t output[16], int32_t input[16]);
 ...
 *  \param  output          DCT values.
 */
void lib_dsp_dct_forward12(int32_t output[12], int32_t input[12]);
 ...
 *  \param  output          DCT values.
 */
void lib_dsp_dct_forward8(int32_t output[8], int32_t input[8]);
 ...
 *  \param  output          DCT values.
 */
void lib_dsp_dct_forward6(int32_t output[6], int32_t input[6]);
