 ...
 * 
 *  \code
 *  int result = lib_dsp_vector_mean( input_vector, 256, 28 );
 *  \endcode
 */
 ...
 * 
 *  \code
 *  int result = lib_dsp_vector_power( input_vector, 256, 28 );
 *  \endcode
 */
 ...
 *  \param  q_format        Fixed point format (i.e. number of fractional bits).
 * 
 *  Algorithm: R = ((X[0]^2 + ... + X[N-1]^2) / N) ^ 0.5)
 * 
 *  \code
 *  result = 0
 *  for i = 0 to N-1: result += input_vector_X[i]
 ...
 * 
 *  \code
 *   int result = lib_dsp_vector_rms( input_vector, 256, 28 );
 *  \endcode
 */
 ...
 *  \param  q_format        Fixed point format (i.e. number of fractional bits).
 * 
 *  Algorithm: R = X[0] * Y[0] + ... X[N-1] * Y[N-1]
 * 
 *  \code
 *  result = 0
 ...
 * 
 *  \code
 *  int result = lib_dsp_vector_dotprod( input_vector, 256, 28 );
 *  \endcode
 */
