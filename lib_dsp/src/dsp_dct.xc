...
static const int32_t costable16[8] = {
    2137142927, 2055013723, 1893911494, 1660027308,
    1362349204, 1012316784, 623381598,  210490206,
};

static const int32_t costable32[16] = {
    2144896910, 2124240380, 2083126254, 2021950484, 1941302225, 1841958164,
    1724875040, 1591180426, 1442161874, 1279254516, 1104027237, 918167572,
    723465451,  521795963,  315101295,  105372028,
};
...
static const int32_t costable12[6] = {
    2129111628, 1984016189, 1703713325, 1307305214, 821806413, 280302863,
};

static const int32_t costable24[12] = {
    2142885721, 2106220352, 2033516969, 1926019547, 1785567396, 1614563692,
    1415934356, 1193077991, 949807730,  690285996,  418953276,  140452151,
};

static const int32_t costable48[24] = {
    2146333858, 2137142927, 2118800422, 2091384888, 2055013723, 2009842673,
    1956065169, 1893911494, 1823647798, 1745574963, 1660027308, 1567371161,
    1468003290, 1362349204, 1250861329, 1134017074, 1012316784, 886281597,
    756451217,  623381597,  487642561,  349815365,  210490206,  70263695,
};
...
void dsp_dct_forward4(int32_t output[4], int32_t input[4]) {
  ...
  output[1] = mulcos(i03_, 1984016189) + mulcos(i12_, 821806413);
  output[3] = mulcos(i03_, 821806413) + mulcos(i12_, -1984016189);
}
