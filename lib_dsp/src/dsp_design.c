...
void dsp_design_biquad_notch(double        frequency,
                             double        filter_Q,
...
void dsp_design_biquad_lowpass(double        frequency,
                               double        filter_Q,
                               int32_t       coefficients[5],
                               const int32_t q_format) {
  // Compute common factors
...
void dsp_design_biquad_highpass(double        frequency,
                                double        filter_Q,
                                int32_t       coefficients[5],
                                const int32_t q_format) {
  // Compute common factors
...
void dsp_design_biquad_allpass(double        frequency,
                               double        filter_Q,
                               int32_t       coefficients[5],
                               const int32_t q_format) {
  // Compute common factors
...
void dsp_design_biquad_bandpass(double        frequency1,
                                double        frequency2,
                                int32_t       coefficients[5],
                                const int32_t q_format) {
  // Compute common factors
...
void dsp_design_biquad_peaking(double        frequency,
                               double        filter_Q,
                               double        gain_db,
                               int32_t       coefficients[5],
                               const int32_t q_format) {
...
void dsp_design_biquad_lowshelf(double        frequency,
                                double        filter_Q,
...
void dsp_design_biquad_highshelf(double        frequency,
                                 double        filter_Q,
                                 double        shelf_gain_db,
                                 int32_t       coefficients[5],
                                 const int32_t q_format) {
