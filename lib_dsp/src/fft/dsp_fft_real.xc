...
extern  void dsp_fft_real_fix_xs2(dsp_complex_t pts[], const uint32_t N, const int32_t sine[] );

#pragma unsafe arrays
void dsp_fft_real_fix(dsp_complex_t pts[], const uint32_t N, const int32_t sine[] ) {
    int shift = 32;
...
void dsp_fft_bit_reverse_and_forward_real (
    ...
    dsp_fft_real_fix_xs2((pts, dsp_complex_t[]), N>>1, sin2);
}
