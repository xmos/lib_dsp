...
void dsp_vector_mulv_complex(const int32_t *input_vector_X_re,
  ...
  while (vl >= 8) {
    ...
    asm("lmul %0, %1, %2, %3, %4, %5"
        : "=r"(ah), "=r"(al)
        : "r"(x0_re0), "r"(y0_re0), "r"(zero), "r"(zero));
    asm("lextract %0, %1, %2, %3, 32"
        : "=r"(z0_00)
        : "r"(ah), "r"(al), "r"(q_format));
    ...
    asm("lmul %0, %1, %2, %3, %4, %5"
        : "=r"(ah), "=r"(al)
        : "r"(x0_im0), "r"(y0_im0), "r"(zero), "r"(zero));
    asm("lextract %0, %1, %2, %3, 32"
        : "=r"(z0_10)
        : "r"(ah), "r"(al), "r"(q_format));
    ...
    asm("lmul %0, %1, %2, %3, %4, %5"
        : "=r"(ah), "=r"(al)
        : "r"(x0_re0), "r"(y0_im0), "r"(zero), "r"(zero));
    asm("maccs %0, %1, %2, %3"
        : "=r"(ah), "=r"(al)
        : "r"(x0_im0), "r"(y0_re0), "0"(ah), "1"(al));
    ...
    asm("lmul %0, %1, %2, %3, %4, %5"
        : "=r"(ah), "=r"(al)
        : "r"(x0_re1), "r"(y0_re1), "r"(zero), "r"(zero));
    asm("lextract %0, %1, %2, %3, 32"
        : "=r"(z0_01)
        : "r"(ah), "r"(al), "r"(q_format));
    ...
    asm("lmul %0, %1, %2, %3, %4, %5"
        : "=r"(ah), "=r"(al)
        : "r"(x0_im1), "r"(y0_im1), "r"(zero), "r"(zero));
    asm("lextract %0, %1, %2, %3, 32"
        : "=r"(z0_11)
        : "r"(ah), "r"(al), "r"(q_format));
    ...
    asm("lmul %0, %1, %2, %3, %4, %5"
        : "=r"(ah), "=r"(al)
        : "r"(x0_re1), "r"(y0_im1), "r"(zero), "r"(zero));
    asm("maccs %0, %1, %2, %3"
        : "=r"(ah), "=r"(al)
        : "r"(x0_im1), "r"(y0_re1), "0"(ah), "1"(al));
    ...
    input_vector_X_re += 8;
    input_vector_Y_re += 8;
    result_vector_R_re += 8;
    input_vector_X_im += 8;
    input_vector_Y_im += 8;
    result_vector_R_im += 8;
  }

  while (vl--) {
    x0_re0 = *input_vector_X_re++;
    x0_im0 = *input_vector_X_im++;
    y0_re0 = *input_vector_Y_re++;
    y0_im0 = *input_vector_Y_im++;
