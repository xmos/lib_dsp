...
int32_t firCoeffs[] = {Q24(.11), Q24(.12), Q24(.13), Q24(.14), Q24(.15),
                       Q24(.16), Q24(.17), Q24(.18), Q24(.19), Q24(.20),
                       Q24(.21), Q24(.22), Q24(.23), Q24(.24), Q24(.25),
                       Q24(.26), Q24(.27), Q24(.28), Q24(.29), Q24(.30),
                       Q24(.31), Q24(.32), Q24(.33), Q24(.34), Q24(.35),
                       Q24(.36), Q24(.37), Q24(.38), Q24(.39), Q24(.40)};

int32_t firCoeffsInt[] = {
    Q31(+0.0391607),  Q31(+0.0783215),  Q31(+0.0191607),  Q31(+0.01531791),
    Q31(-0.03098222), Q31(+0.0391607),  Q31(+0.0783215),  Q31(+0.0191607),
    Q31(+0.01531791), Q31(-0.03098222), Q31(+0.0391607),  Q31(+0.0783215),
    Q31(+0.0191607),  Q31(+0.01531791), Q31(-0.03098222), Q31(+0.0391607),
...
tmr:
  ...
  for (i = 0; i < SAMPLE_LENGTH; i++) {
    TIME_FUNCTION(
        Dst[i] = dsp_filters_fir(Src[i],    // Input data sample to be filtered
  ...
  for (i = 0; i < SAMPLE_LENGTH; i++) {
    TIME_FUNCTION(Dst[i] = dsp_filters_biquad(
                      Src[i],      // Input data sample to be filtered
  ...
  // Apply IIR filter and store filtered data
  for (i = 0; i < SAMPLE_LENGTH; i++) {
    TIME_FUNCTION(Dst[i] = dsp_filters_biquads(
                      Src[i],            // Input data sample to be filtered
                      iirCoeffs,         // Pointer to filter coefficients
                      filterState,       // Pointer to filter state array
