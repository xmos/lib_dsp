...
lib_dsp_fft_complex_t data[8192];
...
int main( void )
{
    for( int cc = 8; cc <= 8192; cc *= 2 )
    {
        ...
        //printf( "Size=%4u FFT_Clocks=%7u iFFT_Clocks=%7u\n", cc, (t2-t1), (t4-t3) );
    }
    printf( "DONE.\n" );
    return 0;
}
