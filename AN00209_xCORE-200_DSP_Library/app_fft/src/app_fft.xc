...
/**
 * Experiments with functions that generate sine and cosine signals with a
...
tmr:
  ...
  tmr:
    ...
    dsp_fft_short_to_long(
        data, tmp_data, N_FFT_POINTS); // convert into tmp buffer
    ...
    dsp_fft_long_to_short(
        tmp_data, data, N_FFT_POINTS); // convert from tmp buffer
#else
