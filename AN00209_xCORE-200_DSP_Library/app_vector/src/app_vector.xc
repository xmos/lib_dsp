...
int main(void) {
  ...
  dsp_vector_minv((Src4, uint32_t[]),
                  (Src3, uint32_t[]), // Input vector
                  8);                 // Vector length
  for (int i = 0; i < 8; i++) {
    if (Dst[i] != Src4[i]) {
  ...
  dsp_vector_mulv_complex(A_real,
                          A_imag,
                          B_real,
                          B_imag,
                          C_real,
                          C_imag,
                          COMPLEX_VECTOR_LENGTH,
                          Q_N);
