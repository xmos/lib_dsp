...
int main(void) {
  ...
  */
  ...
  int32_t input_vector[2] = {Q24(sqrt(3) / 2), Q24(0.5)}; // 30 degree vector
  ...
  dsp_matrix_mulm(
      rotation_matrix, // 'input_matrix_X':  Pointer to source data array X
  ...
  printf("Result of multiplying column vector X[2] with rotation matrix "
         "Y[2][2] (90 degrees rotation):\n");
  printf("%.8f\n", F24(rotated_vector[0]));
  printf("%.8f\n", F24(rotated_vector[1]));
  // Matrix negation: R = -X
  dsp_matrix_negate(
      Src1, // 'input_matrix_X':  Pointer/reference to source data
      Dst,  // 'result_matrix_R': Pointer to the resulting 2-dimensional data
            // array
  ...
  dsp_matrix_muls(
      ...
      3,       // 'row_count':       Number of rows in input and output matrices
      3,    // 'column_count':    Number of columns in input and output matrices
      Q_N); // 'q_format':        Fixed point format, the number of bits making
            // up fractional part
  ...
  dsp_matrix_addm(
      Src1, // 'input_matrix_X':  Pointer to source data array X
  ...
  dsp_matrix_transpose(
      Src1, // 'input_matrix_X':  Pointer to source data array
      Dst,  // 'result_matrix_R': Pointer to the resulting 2-dimensional data
            // array
      3,    // 'row_count':       Number of rows in input and output matrices
      3,    // 'column_count':    Number of columns in input and output matrices
